  ...
  return (
    <div id="main" className="container beta-agreement-page">
      <section className="beta-agreement-card">
        ...
        <p className="agreement-deck">Before entering My BoardSignal, here is the plain-language agreement for this Founding Beta.</p>
        <ul>
          ...
          <li><strong>Each completed Founding Beta review may contribute at least one safe positive or neutral public highlight around BoardSignal.</strong></li>
        ...
        <label className="agreement-check"><input type="checkbox" checked={understood} onChange={(event) => setUnderstood(event.target.checked)} /><span>I understand and accept the Founding Beta Agreement, including safe public participation.</span></label>
