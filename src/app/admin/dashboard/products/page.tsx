        ...
        <div className="container">
          <div className="mx-auto max-w-6xl">
              ...
              <div className="card-elevated overflow-hidden">
                <div className="bg-[linear-gradient(180deg,#fffefb_0%,#f7f1e4_100%)] p-6 md:p-10">
                  ...
                  <p className="mt-4 max-w-[62ch] text-base leading-8 text-[var(--text-secondary)]">
                    ...
                    across Sparkle Legacy’s public cover pages. These entries
                    shape the product listings clients see under short-term,
                    long-term, retirement, business, and other insurance
                    categories.
                  </p>
                  ...
                  <div className="mt-5 rounded-[1.25rem] border border-[var(--border)] bg-[var(--surface)] p-4">
                    ...
                    <ul className="mt-3 space-y-2">
                      {[
                        ...
                        "Use short summaries that explain the core value quickly.",
                        "Only mark products active when they are ready for public display.",
                        "Use order values to control the sequence on public pages.",
                      ].map((item) => (
                        <li
                          key={item}
              ...
              {filtered.length === 0 ? (
                <div className="frame-gold p-8 text-center">
                  ...
                  <p className="mx-auto mt-3 max-w-[54ch] text-sm leading-7 text-[var(--text-secondary)]">
                    Add a new insurance product to begin populating the public
                    product sections.
                  </p>
                                ...
                                <div className="min-w-0">
                                  ...
                                  <div className="mt-3 flex flex-wrap gap-2 text-xs text-[var(--text-muted)]">
                                    ...
                                    {!!product.whatItCovers?.length && (
                                      <span className="rounded-full border border-[var(--border)] bg-[var(--surface)] px-2.5 py-1 font-semibold">
                                        Covers: {product.whatItCovers.length}
                                      </span>
                                    )}
            ...
            <div className="mt-8 frame-gold p-5 text-sm leading-7 text-[var(--text-secondary)]">
              ...
              records power the public insurance category pages, so keep each
              entry clear, accurate, and easy for clients to understand.
            </div>
          </div>
        </div>
      </section>
