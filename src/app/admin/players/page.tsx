...
import FounderIdentityAccessCases from "@/components/FounderIdentityAccessCases";
...
export default function PlayersAdminPage() {
  return <div id="main" className="container admin-shell founder-players-v2"><header className="admin-heading"><div><p className="kicker">Identity and membership</p><h1>Players</h1></div></header><AdminNav /><FounderIdentityAccessCases /><FoundingBetaPlayersAdmin />
