...
export default async function PublicPlayerPage({ params }: { params: Promise<{ handle: string }> }) {
  ...
  return (
    <div id="main" className="container public-player-page">
      ...
      </section> : <section className="public-coverage-empty"><Sparkles /><p className="kicker">HIGHLIGHTS COMING</p><h2>Your public highlights will appear here once your Founding Beta identity is reviewed.</h2><p>A private My BoardSignal can already exist before this page is public. Private improvement guidance and reviewed positions never appear here.</p></section>}
