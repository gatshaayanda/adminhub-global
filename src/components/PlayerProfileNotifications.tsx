...
export default function PlayerProfileNotifications({
  ...
  return <section className="player-profile-section">
    ...
    <div className="profile-settings-grid">
      ...
      <article className="profile-settings-card"><h3>Community</h3><div className="required-participation-row"><ShieldCheck size={17} /><div><strong>Founding Beta public highlights = Included</strong><p>Each completed review can contribute a safe positive or neutral highlight. Private improvement guidance, reviewed positions and progress stay private.</p></div></div>{discordInvite ? <a className="button button-outline" href={discordInvite} target="_blank" rel="noreferrer">Join the Founding Beta Discord</a> : null}</article>
