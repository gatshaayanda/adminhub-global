...
function emptyAggregate(now = new Date()): FounderOperationsAggregate {
  return {
    ...
    validation: { playersServed: 0, verifiedReviews: 0, originalReviews: 0, liveReviews: 0, originalToLive: 0, r2Plus: 0, r3Plus: 0, r4: 0, dataCompleteness: DATA_COMPLETENESS },
  };
}
