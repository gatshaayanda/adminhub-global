...
export default async function PublicPlayerPage({ params }: { params: Promise<{ handle: string }> }) {
  ...
  return (
    <div id="main" className="container public-player-page">
      ...
      </section> : <section className="public-coverage-empty"><Sparkles /><p className="kicker">COVERAGE FORMING</p><h2>No approved public BoardSignal story is attached to this player yet.</h2><p>Their Chess.com identity may exist, but BoardSignal will not expose a private Desk or invent a public highlight.</p></section>}
