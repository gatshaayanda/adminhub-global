...
export default function FoundingBetaPlayersAdmin() {
  ...
  return <>
    ...
    <section className="desk-section founder-player-directory">
      <div className="founder-directory-heading"><div><p className="kicker">IDENTITY AND MEMBERSHIP</p><h2>Players</h2><p>Private access, identity review, public highlights and fallback recovery are separate server-derived states.</p></div></div>
